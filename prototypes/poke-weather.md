...
POKE Weather tests whether a basic utility can feel memorable through theme, animation, and fast visual feedback.

## What It Demonstrates

- Playful frontend direction.
- Weather-data interface design.
- Animation and visual state mapping.
- Quick prototype-to-usable-surface execution.
...
- Reliable weather provider boundary.
